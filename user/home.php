...
include '../crud/user/display_unbookedEvent.php';
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a onclick="return confirm('Are you sure you want to book the event?')" href="../crud/user/book_Event.php?event_id=<?php echo $row['event_id'] ?>&user_id=<?php echo $_SESSION['user']['user_id'] ?>" type="button" class="btn btn-primary">Book</a>
...
<?php  } else { ?>
    ...
    <div class="container-empty">
        ...
        <div class="section-title">
            <p>Out of events, stay updated for new updates.</p>
        </div>

        <div class="btn-empty">
            <a href="event.php#" type="button" class="btn btn-primary">View Booked Events</a>
        </div>
